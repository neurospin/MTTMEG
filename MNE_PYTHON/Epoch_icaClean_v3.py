...
def Epoch_icaClean_v3(conditions,datasource,subject,runpersubject, badeeg):
...
#    #meg_tag        = 'True'
    ...
    for j,run in enumerate(runpersubject):
        ...
        #for c in range(len(conditions)):c
    ...
    for c,cond in enumerate(conditions):
        ...
        epoch_tot = mne.epochs.concatenate_epochs([epochs_list_subj[e][c] 
        for e in range(len(epochs_list_subj)) if epochs_list_subj[e][c]])
