# -*- coding: utf-8 -*-
"""
Created on Thu Nov 17 19:11:47 2016
...
label_path = '/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/MEG/GROUP/labels_user_defined/QsWestParEast'

label_list = (os.listdir(label_path))

graphcolor = ((0.7,0.7,1),
              (0.35,0.35,1),
              (0,0,1))
...
for l,labeltag in enumerate(label_list):
    ...
    ax1.plot((0,0),(0.5,5),linewidth = 3,linestyle='--',color = (0.5,0.5,0.5))
    ax1.plot((1,1),(0.5,5),linewidth = 3,linestyle='--',color = (0.5,0.5,0.5))
    for c,cond in enumerate(condition):
