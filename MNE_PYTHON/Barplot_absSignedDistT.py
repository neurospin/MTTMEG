...
label_path = '/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/MEG/GROUP/labels_user_defined/absSignedDistTLinReg'
...
for l,labeltag in enumerate(label_list):
    ...
    stc_fname = (path +'/IcaCorr_BETAp005uncorr_MEEG_LinRegressabs8bin_TsignedEVT_twin'+str(twin[0])+'-'+str(twin[1])+'ms_pick_oriNone_dSPM_ico-5-fwd-fsaverage.stc-lh.stc')
