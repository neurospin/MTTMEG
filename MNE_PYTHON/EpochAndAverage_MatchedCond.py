...
def EpochAndAverage_MatchedCond(conditions,datasource,subject,runpersubject, badeeg):
...
#    datasource    = ('QTT','QTS')
    ...
    for j,run in enumerate(runpersubject):
        ...
        for c,cond in enumerate(conditions):
            ...
            epochs_list.append(Epoch(wdir, raw, SelEve, event_id.tolist(), -0.2, 1.1, -0.2, 0)) 
            #(epochs)
