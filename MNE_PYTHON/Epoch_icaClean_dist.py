...
initbody = initbody + "import Epoch_icaClean_v3 as Eic\n"
...
for s,subj in enumerate(ListSubj):
    for m,mod in enumerate(modalities):
        for c,cond in enumerate(CondComb):
            ...
            body = initbody + "Eic.Epoch_icaClean_v3(" + str(CondComb[c])        
            ...
            name_file = []
            name_file = os.path.join(path_script, ("JOBS_PREPROC/Preproc_ica_dist.py"))
...
for i in range(len(Listfile)):
    ...
    somaWF_name = os.path.join(path_script, "SOMA_WFs/soma_WF_PREPROCica_dist")
