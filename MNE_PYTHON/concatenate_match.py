# -*- coding: utf-8 -*-
"""
Created on Thu Mar  3 10:47:26 2016
...
def concatenate_match(conditions,subject,runpersubject):
...
#    #eeg_tag        = 'True'
    ...
    for j,run in enumerate(runpersubject):
        ...
        for c,cond in enumerate(conditions):
            ...
            epochs = []
            epochs = mne.read_epochs((wdir + subject + "/mne_python/EPOCHS/" + modality + "_epochs_run" + run + "_" +
