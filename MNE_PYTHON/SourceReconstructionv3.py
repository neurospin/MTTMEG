def SourceReconstructionv3(condarray,condrenames,ListSubj,modality,Method,covmatsource):
#
    ...
    for c in range(len(condarray)):
        for i in range(len(ListSubj)):
            ...
            if len(condarray[c]) == 1:
                ...
                fname_epochs      = (wdir+ListSubj[i]+"/mne_python/EPOCHS/MEEG_epochs_" +condnames+ '_' + ListSubj[i]+"-epo.fif")          
