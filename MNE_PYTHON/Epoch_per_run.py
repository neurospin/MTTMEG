# -*- coding: utf-8 -*-
"""
Created on Thu Mar  3 10:22:43 2016

@author: bgauthie
"""

def Epoch_per_run(conditions,datasource,subject,runpersubject, badeeg):
...
#    conditions    = ('EtPast','EtPre','EtFut')
#    datasource    = ('EVT','EVT','EVT')
#    #meg_tag        = 'True'
#    #eeg_tag        = 'True'
    modality = 'MEEG'
    ...
    for j,run in enumerate(runpersubject):
        ...
        for c,cond in enumerate(conditions):
            ...
            epochs.save(wdir + subject + "/mne_python/EPOCHS/" + modality + "_epochs_run" + run + "_" +
