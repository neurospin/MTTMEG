function   ERFstatREG_GroupLvl_v2(condnames,GDAVG, GDAVGt, chansel_, data1,data2,data3,graphcolor)
        ...
        for k = 1:length(stat.posclusters)
            if stat.posclusters(1,k).prob < 0.07
               ...
               % RASTER PLOT Tvalues
                ...
                hold on
                legend(condnames{1},condnames{2},condnames{3},'Location','NorthWest')
