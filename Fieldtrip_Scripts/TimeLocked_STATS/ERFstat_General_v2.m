function ERFstat_General_v2(condnames,latency,GDAVG,GDAVGt, chansel_,graphcolor,stat_test,varargin)
...
%                         cfg.comment              = [num2str(round(stat.time(1+n*(j-1))*100)/100) ];
                ...
                folder = '/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/ERFPs_new/';
                ...
                save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/spatial_clust_new/stats_posclust_' num2str(countpos) '_' cdn '_' chansel_ '_Lat' num2str(latency(1)) '-' num2str(latency(2)) '_stimlock_' timetag '.mat'],'stat','chansel','condnames')
...
%                         cfg.comment              = [num2str(round(stat.time(1+n*(j-1))*100)/100) ];
                ...
                save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/spatial_clust_new/stats_negclust_'  num2str(countneg) '_' cdn '_' chansel_ '_Lat' num2str(latency(1)) '-' num2str(latency(2)) '_stimlock_' timetag '.mat'],'stat','chansel','condnames')
