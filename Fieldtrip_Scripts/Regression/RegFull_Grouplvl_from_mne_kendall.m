function RegFull_Grouplvl_from_mne_kendall(niplist,chansel,condnames,newnames,latency,graphcolor,test)
...
for j = 1:length(niplist)
    datatmp{j}   = load(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' niplist{j} '/MegData/ERPs_from_mne/REG' cdn chansel],'CorrKendallPerChanTime');
end
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% COMPUTE ERFS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
for i = 1:length(datatmp{1,1}.CorrKendallPerChanTime)
    ...
    for j = 1:length(datatmp)
        instr = [instr 'datatmp{1,' num2str(j)  '}.CorrKendallPerChanTime,'];
    end
    instr(end) = [];
    instr      = [instr ');'];
