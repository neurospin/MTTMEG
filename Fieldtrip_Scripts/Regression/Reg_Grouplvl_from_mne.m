function Reg_GROUPlvl_from_mne(niplist,chansel,condnames,latency,graphcolor,test,newnames)
...
for j = 1:length(niplist)
    datatmp{j}   = load(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' niplist{j} '/MegData/ERPs_from_mne/' cdn chansel],'RegPerChanTime');
end
