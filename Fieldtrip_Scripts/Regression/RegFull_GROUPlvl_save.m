function RegFull_GROUPlvl_save(niplist,chansel,condnames,latency,graphcolor,test)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
instr = 'ERFstat_savestat(condnames, latency, GDAVG, GDAVGt, chansel,graphcolor,test,';
