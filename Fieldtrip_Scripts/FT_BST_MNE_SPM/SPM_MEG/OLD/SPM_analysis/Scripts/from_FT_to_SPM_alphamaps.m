...
list_run  = {{'run1';'run2'}};        
list_cond = {'50','75','100','150','200','300','400','600'};
freq_alpha = [[10.5 11.5];[10 11];[9.5 10.5];[9 10];[10 11]];
...
for i = 1:length(list_sub)
    for j = 1:length(list_run{i})
        for k = 1:length(list_cond)
            ...
            matlabbatch{2}.spm.meeg.tf.tf.frequencies = [1:0.5:30];
            matlabbatch{2}.spm.meeg.tf.tf.timewin = [-Inf Inf];
            matlabbatch{2}.spm.meeg.tf.tf.method.mtmconvol.taper = 'hanning';
            matlabbatch{2}.spm.meeg.tf.tf.method.mtmconvol.timeres = 4000;
            matlabbatch{2}.spm.meeg.tf.tf.method.mtmconvol.timestep = 2000;
            matlabbatch{2}.spm.meeg.tf.tf.method.mtmconvol.freqres = 0.25;
            matlabbatch{2}.spm.meeg.tf.tf.phase = 0;
            matlabbatch{2}.spm.meeg.tf.tf.prefix = 'StimAlpha';
            ...
            matlabbatch{3}.spm.meeg.images.convert2images.mode = 'scalp';
            ...
            matlabbatch{3}.spm.meeg.images.convert2images.freqwin = freq_alpha(i,:);
            matlabbatch{3}.spm.meeg.images.convert2images.prefix = 'Scan_';
