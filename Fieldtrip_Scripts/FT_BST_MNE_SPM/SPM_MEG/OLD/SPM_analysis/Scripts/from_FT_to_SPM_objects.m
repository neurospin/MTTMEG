...
filepath = 'C:\Users\bgauthie\Desktop\CLEAN_SPM\from_fieldtrip\FT2SPM_data\localizer_object.mat';
load(filepath)
...
save('C:\Users\bgauthie\Desktop\CLEAN_SPM\from_fieldtrip\FT2SPM_data\localizer_object_converted.mat','D');

%% ERF computation (code generated from SPM interobject)
% Add additional spatial informations on channels lost at the conversion step
matlabbatch{1}.spm.meeg.preproc.prepare.D = {'C:\Users\bgauthie\Desktop\CLEAN_SPM\from_fieldtrip\FT2SPM_data\localizer_object_converted.mat'};
...
matlabbatch{6}.spm.meeg.source.headmodel.D = {'C:\Users\bgauthie\Desktop\CLEAN_SPM\from_fieldtrip\FT2SPM_data\mblocalizer_object_converted.mat'};
...
% fiducial points specification (coordinate exploration by "display" interobject with the GUI
...
% inverse model
matlabbatch{7}.spm.meeg.source.invert.D = {'C:\Users\bgauthie\Desktop\CLEAN_SPM\from_fieldtrip\FT2SPM_data\mblocalizer_object_converted.mat'};
