...
list_run  = {{'run1';'run2'}};        
list_cond = {'50','75','100','150','200','300','400','600'};
freq_fund = (ones(1,8))./[50 83 100 150 200 300 400 600]*1000;
...
for i = 1:length(list_sub)
    for j = 1:length(list_run{i})
        for k = 1:length(list_cond)
            ...
            matlabbatch{2}.spm.meeg.tf.tf.prefix = 'Stimfund';
            ...
            matlabbatch{3}.spm.meeg.images.convert2images.freqwin = [freq_fund(k) freq_fund(k)];
