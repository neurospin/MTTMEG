...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%% making RT for good resp %%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

RT = load('C:\MTT_MEG\results\PSYCH_RT.mat');
ER = load('C:\MTT_MEG\results\PSYCH_ERR.mat');

for i = 1:6
    RT.DATARef_el130325{1,i} = RT.DATARef_el130325{1,i}.*(squeeze(ER.DATARef_el130325{1,i}))';
    RT.DATARef_PB130006{1,i} = RT.DATARef_PB130006{1,i}.*(squeeze(ER.DATARef_PB130006{1,i}))';
    RT.DATARef_sb130326{1,i} = RT.DATARef_sb130326{1,i}.*(squeeze(ER.DATARef_sb130326{1,i}))';
    RT.DATARef_df130078{1,i} = RT.DATARef_df130078{1,i}.*(squeeze(ER.DATARef_df130078{1,i}))';
    RT.DATARef_jn120580{1,i} = RT.DATARef_jn120580{1,i}.*(squeeze(ER.DATARef_jn120580{1,i}))';
end
for i = 1:6
    RT.DATARef_el130325{1,i}(RT.DATARef_el130325{1,i} == 0) = NaN;
    RT.DATARef_PB130006{1,i}(RT.DATARef_PB130006{1,i} == 0) = NaN;
    RT.DATARef_sb130326{1,i}(RT.DATARef_sb130326{1,i} == 0) = NaN;
    RT.DATARef_df130078{1,i}(RT.DATARef_df130078{1,i} == 0) = NaN;
    RT.DATARef_jn120580{1,i}(RT.DATARef_jn120580{1,i} == 0) = NaN;
end

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
REF1(1,:) = nanmean(RT.DATARef_PB130006{1,1},1);
REF1(2,:) = nanmean(RT.DATARef_df130078{1,1},1);
REF1(3,:) = nanmean(RT.DATARef_el130325{1,1},1);
REF1(4,:) = nanmean(RT.DATARef_jn120580{1,1},1);
REF1(5,:) = nanmean(RT.DATARef_sb130326{1,1},1);
REF1mean  = nanmean(REF1);
REF1std   = nanstd(REF1);

REF2(1,:) = nanmean(RT.DATARef_PB130006{1,2},1);
REF2(2,:) = nanmean(RT.DATARef_df130078{1,2},1);
REF2(3,:) = nanmean(RT.DATARef_el130325{1,2},1);
REF2(4,:) = nanmean(RT.DATARef_jn120580{1,2},1);
REF2(5,:) = nanmean(RT.DATARef_sb130326{1,2},1);
REF2mean  = nanmean(REF2);
REF2std   = nanstd(REF2);

REF3(1,:) = nanmean(RT.DATARef_PB130006{1,3},1);
REF3(2,:) = nanmean(RT.DATARef_df130078{1,3},1);
REF3(3,:) = nanmean(RT.DATARef_el130325{1,3},1);
REF3(4,:) = nanmean(RT.DATARef_jn120580{1,3},1);
REF3(5,:) = nanmean(RT.DATARef_sb130326{1,3},1);
REF3mean  = nanmean(REF3);
REF3std   = nanstd(REF3);

REF4(1,:) = nanmean(RT.DATARef_PB130006{1,4},1);
REF4(2,:) = nanmean(RT.DATARef_df130078{1,4},1);
REF4(3,:) = nanmean(RT.DATARef_el130325{1,4},1);
REF4(4,:) = nanmean(RT.DATARef_jn120580{1,4},1);
REF4(5,:) = nanmean(RT.DATARef_sb130326{1,4},1);
REF4mean  = nanmean(REF4);
REF4std   = nanstd(REF4);

REF5(1,:) = nanmean(RT.DATARef_PB130006{1,5},1);
REF5(2,:) = nanmean(RT.DATARef_df130078{1,5},1);
REF5(3,:) = nanmean(RT.DATARef_el130325{1,5},1);
REF5(4,:) = nanmean(RT.DATARef_jn120580{1,5},1);
REF5(5,:) = nanmean(RT.DATARef_sb130326{1,5},1);
REF5mean  = nanmean(REF5);
REF5std   = nanstd(REF5);

REF6(1,:) = nanmean(RT.DATARef_PB130006{1,6},1);
REF6(2,:) = nanmean(RT.DATARef_df130078{1,6},1);
REF6(3,:) = nanmean(RT.DATARef_el130325{1,6},1);
REF6(4,:) = nanmean(RT.DATARef_jn120580{1,6},1);
REF6(5,:) = nanmean(RT.DATARef_sb130326{1,6},1);
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_RTforER_MT_MEG_PSYCHO'])
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_RTforER_MT_MEG_PSYCHO')
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_RTforER_MT_MEG_PSYCHO'])
...
for i = 1:6
    RT.DATARef_el130325{1,i}(ER.DATARef_el130325{1,i} == 1)  = NaN;
    RT.DATARef_PB130006{1,i}(ER.DATARef_PB130006{1,i} == 1)  = NaN;
    RT.DATARef_sb130326{1,i}(ER.DATARef_sb130326{1,i} == 1)  = NaN;
    RT.DATARef_df130078{1,i}(ER.DATARef_df130078{1,i} == 1)  = NaN;
    RT.DATARef_jn120580{1,i}(ER.DATARef_jn120580{1,i} == 1)  = NaN;
end
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_RTforGood_MT_MEG_PSYCHO'])
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_RTforGood_MT_MEG_PSYCHO')
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_RTforGood_MT_MEG_PSYCHO'])
