function DATARef = error_analysis_generic_mttmegpsycho_respcode_MASKED(FOLDER,NIP,varargin)
...
print('-dpng',['C:\MTT_MEG\results\FULL_ER_MT_MEG_PSYCHO_MASKED_' NIP])
...
print('-dpng',['C:\MTT_MEG\results\MEAN_ER_MT_MEG_PSYCHO_MASKED_' NIP])
...
print('-dpng',['C:\MTT_MEG\results\REGRESS_TIME_ER_MT_MEG_PSYCHO_MASKED_' NIP])
...
print('-dpng',['C:\MTT_MEG\results\REGRESS_SPACE_ER_MT_MEG_PSYCHO_MASKED_' NIP])
