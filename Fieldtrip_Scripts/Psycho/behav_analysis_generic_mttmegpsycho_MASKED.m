function DATARef = behav_analysis_generic_mttmegpsycho_MASKED(FOLDER,NIP,varargin)
...
print('-dpng',['C:\MTT_MEG\results\FULL_RT_MT_MEG_PSYCHO_MASKED_' NIP])
...
print('-dpng',['C:\MTT_MEG\results\MEAN_RT_MT_MEG_PSYCHO_MASKED_' NIP])
...
print('-dpng',['C:\MTT_MEG\results\REGRESS_TIME_RT_MT_MEG_PSYCHO_MASKED_' NIP])
...
print('-dpng',['C:\MTT_MEG\results\REGRESS_SPACE_RT_MT_MEG_PSYCHO_MASKED_' NIP])
