function psycho_2(FOLDER,NIP,varargin)
...
[DATES,TXT] = xlsread('C:\Users\bgauthie\Desktop\ONGOING_PROJECTS\MENTAL_TIME_TRAVEL\STIM\EVENTS\EVENTS_Psycho\DATE_IMAGING.xlsx');
[LONGS,TXT]  = xlsread('C:\Users\bgauthie\Desktop\ONGOING_PROJECTS\MENTAL_TIME_TRAVEL\STIM\EVENTS\EVENTS_Psycho\LONG_IMAGING.xlsx');
...
DATARTFULL = [];
DATART = cell(length(REPETITION),4);
