function [DATA_s_Ref,DATA_t_Ref] = error_analysis_generic_mttmegpsycho3rd(FOLDER,NIP,varargin)
...
LONGSind{4} = [1 7 13    2 8 14    3 9 15    4 10 16    5 11 17    6 12 18   ];
LONGSind{5} = [1 7       2 8       3 9       4 10       5 11       6 12      ];
LONGSind{6} = [1 7 13 19 2 8 14 20 3 9 15 21 4 10 16 22 5 11 17 23 6 12 18 24];
