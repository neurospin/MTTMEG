...
REF1(1,:) = nanmean(DATARef_ad120287{1,1},1);
REF1(2,:) = nanmean(DATARef_am090241{1,1},1);
REF1(3,:) = nanmean(DATARef_cv120216{1,1},1);
REF1(4,:) = nanmean(DATARef_gd130362{1,1},1);
REF1(5,:) = nanmean(DATARef_rg130377{1,1},1);
REF1mean  = nanmean(REF1);
REF1std   = nanstd(REF1);

REF2(1,:) = nanmean(DATARef_ad120287{1,2},1);
REF2(2,:) = nanmean(DATARef_am090241{1,2},1);
REF2(3,:) = nanmean(DATARef_cv120216{1,2},1);
REF2(4,:) = nanmean(DATARef_gd130362{1,2},1);
REF2(5,:) = nanmean(DATARef_rg130377{1,2},1);
REF2mean  = nanmean(REF2);
REF2std   = nanstd(REF2);

REF3(1,:) = nanmean(DATARef_ad120287{1,3},1);
REF3(2,:) = nanmean(DATARef_am090241{1,3},1);
REF3(3,:) = nanmean(DATARef_cv120216{1,3},1);
REF3(4,:) = nanmean(DATARef_gd130362{1,3},1);
REF3(5,:) = nanmean(DATARef_rg130377{1,3},1);
REF3mean  = nanmean(REF3);
REF3std   = nanstd(REF3);

REF4(1,:) = nanmean(DATARef_ad120287{1,4},1);
REF4(2,:) = nanmean(DATARef_am090241{1,4},1);
REF4(3,:) = nanmean(DATARef_cv120216{1,4},1);
REF4(4,:) = nanmean(DATARef_gd130362{1,4},1);
REF4(5,:) = nanmean(DATARef_rg130377{1,4},1);
REF4mean  = nanmean(REF4);
REF4std   = nanstd(REF4);

REF5(1,:) = nanmean(DATARef_ad120287{1,5},1);
REF5(2,:) = nanmean(DATARef_am090241{1,5},1);
REF5(3,:) = nanmean(DATARef_cv120216{1,5},1);
REF5(4,:) = nanmean(DATARef_gd130362{1,5},1);
REF5(5,:) = nanmean(DATARef_rg130377{1,5},1);
REF5mean  = nanmean(REF5);
REF5std   = nanstd(REF5);

REF6(1,:) = nanmean(DATARef_ad120287{1,6},1);
REF6(2,:) = nanmean(DATARef_am090241{1,6},1);
REF6(3,:) = nanmean(DATARef_cv120216{1,6},1);
REF6(4,:) = nanmean(DATARef_gd130362{1,6},1);
REF6(5,:) = nanmean(DATARef_rg130377{1,6},1);
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_RT_MT_MEG_PSYCHO_2'])
...
axis([-18 18 0 3]); ylabel('Reaction time (s)');xlabel('Temporal distance(y)');
...
axis([0 18 0 3]); ylabel('Reaction time (s)');xlabel('|Temporal distance| (y)');
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_RT_MT_MEG_PSYCHO_2')
...
text(5,2.8,['R² = ' num2str(STATS2(1)) ', p = ' num2str(STATS2(3))],'color','r')
axis([-160 160 0 3]); ylabel('Reaction time (s)');xlabel('Temporal distance(y)');
...
text(5,2.5,['R² = ' num2str(STATS3(1)) ', p = ' num2str(STATS3(3))],'color','r')
text(5,2.8,['R² = ' num2str(STATS4(1)) ', p = ' num2str(STATS4(3))],'color','g')
axis([0 160 0 3]); ylabel('Reaction time (s)');xlabel('|Temporal distance| (y)');
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_RT_MT_MEG_PSYCHO_2'])
...
REF1(1,:) = nanmean(DATARef_ad120287{1,1},3);
REF1(2,:) = nanmean(DATARef_am090241{1,1},3);
REF1(3,:) = nanmean(DATARef_cv120216{1,1},3);
REF1(4,:) = nanmean(DATARef_gd130362{1,1},3);
REF1(5,:) = nanmean(DATARef_rg130377{1,1},3);
REF1mean  = nanmean(REF1);
REF1std   = nanstd(REF1);

REF2(1,:) = nanmean(DATARef_ad120287{1,2},3);
REF2(2,:) = nanmean(DATARef_am090241{1,2},3);
REF2(3,:) = nanmean(DATARef_cv120216{1,2},3);
REF2(4,:) = nanmean(DATARef_gd130362{1,2},3);
REF2(5,:) = nanmean(DATARef_rg130377{1,2},3);
REF2mean  = nanmean(REF2);
REF2std   = nanstd(REF2);

REF3(1,:) = nanmean(DATARef_ad120287{1,3},3);
REF3(2,:) = nanmean(DATARef_am090241{1,3},3);
REF3(3,:) = nanmean(DATARef_cv120216{1,3},3);
REF3(4,:) = nanmean(DATARef_gd130362{1,3},3);
REF3(5,:) = nanmean(DATARef_rg130377{1,3},3);
REF3mean  = nanmean(REF3);
REF3std   = nanstd(REF3);

REF4(1,:) = nanmean(DATARef_ad120287{1,4},3);
REF4(2,:) = nanmean(DATARef_am090241{1,4},3);
REF4(3,:) = nanmean(DATARef_cv120216{1,4},3);
REF4(4,:) = nanmean(DATARef_gd130362{1,4},3);
REF4(5,:) = nanmean(DATARef_rg130377{1,4},3);
REF4mean  = nanmean(REF4);
REF4std   = nanstd(REF4);

REF5(1,:) = nanmean(DATARef_ad120287{1,5},3);
REF5(2,:) = nanmean(DATARef_am090241{1,5},3);
REF5(3,:) = nanmean(DATARef_cv120216{1,5},3);
REF5(4,:) = nanmean(DATARef_gd130362{1,5},3);
REF5(5,:) = nanmean(DATARef_rg130377{1,5},3);
REF5mean  = nanmean(REF5);
REF5std   = nanstd(REF5);

REF6(1,:) = nanmean(DATARef_ad120287{1,6},3);
REF6(2,:) = nanmean(DATARef_am090241{1,6},3);
REF6(3,:) = nanmean(DATARef_cv120216{1,6},3);
REF6(4,:) = nanmean(DATARef_gd130362{1,6},3);
REF6(5,:) = nanmean(DATARef_rg130377{1,6},3);
REF6mean  = nanmean(REF6);
REF6std   = nanstd(REF6);
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_ER_MT_MEG_PSYCHO_2'])
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_ER_MT_MEG_PSYCHO_2')
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_ER_MT_MEG_PSYCHO_2'])
...
bar([nanmean(nanmean(REF1meansq)) nanmean(nanmean(REF2meansq)) nanmean(nanmean(REF3meansq)) ...
    0 nanmean(nanmean(REF4meansq)) nanmean(nanmean(REF5meansq)) nanmean(nanmean(REF6meansq))],'facecolor',[0.5 0.5 0.5]);
set(gca,'xtick',1:7,'xticklabel',{'Past';'Present';'Future';'';'West';'Paris';'East'}); hold on;
errorbar(1:7,[nanmean(nanmean(REF1meansq)) nanmean(nanmean(REF2meansq)) nanmean(nanmean(REF3meansq)) ...
    0 nanmean(nanmean(REF4meansq)) nanmean(nanmean(REF5meansq)) nanmean(nanmean(REF6meansq))],...
    [nanstd(REF1meansq(:)) nanstd(REF2meansq(:)) nanstd(REF3meansq(:)) ...
    0 nanstd(REF4meansq(:)) nanstd(REF5meansq(:)) nanstd(REF6meansq(:))]./sqrt(5),'linestyle','none','color','k');
...
subplot(2,1,1)
bar([coef3(1:3) 0 coef3(4:6)],'facecolor',[0.5 0.5 0.5]); ylabel('lin slope')
subplot(2,1,2)
bar([coef4(1:3) 0 coef4(4:6)],'facecolor',[0.5 0.5 0.5]); ylabel('log slope')
set(gca,'xtick',1:7,'xticklabel',{'Past';'Present';'Future';'';'West';'Paris';'East'}); hold on;
