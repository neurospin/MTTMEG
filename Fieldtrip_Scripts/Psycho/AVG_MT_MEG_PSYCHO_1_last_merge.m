...
load('C:\MTT_MEG\results\PSYCH_RT_trial1_merge');
% load('PSYCH_RT_lastt_merge');
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_RT_MT_MEG_PSYCHO_merge_1st'])
...
P1 = polyfit(tmpB(:,1),tmpB(:,2),1);            Y1 = polyval(P1,-18:0.1:-0.1);
P2 = polyfit(tmpA(:,1),tmpA(:,2),1);            Y2 = polyval(P2,0.1:0.1:18);
P3 = polyfit(NormTmp(:,1),NormTmp(:,2),1);      Y3 = polyval(P3,0.1:0.1:18);
P4 = polyfit(log(NormTmp(:,1)),NormTmp(:,2),1); Y4 = polyval(P4,log(0.1:0.1:18));
...
plot(-18:0.1:-0.1,Y1,'color',[1 0.4 0.4],'linewidth',2); plot(0.1:0.1:18,Y2,'color',[1 0.4 0.4],'linewidth',2);
...
plot(0.1:0.1:18,Y3,'color',[1 0 0],'linewidth',2); hold on;
plot(0.1:0.1:18,Y4,'color',[0 1 0],'linewidth',2); hold on;
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_RT_MT_MEG_PSYCHO_merge_1st')
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_RT_MT_MEG_PSYCHO_merge_1st'])
...
% load('C:\MTT_MEG\results\PSYCH_RT_trial1_merge');
load('C:\MTT_MEG\results\PSYCH_RT_lastt_merge');
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_RT_MT_MEG_PSYCHO_merge_last'])
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_RT_MT_MEG_PSYCHO_merge_last')
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_RT_MT_MEG_PSYCHO_merge_last'])
...
load('C:\MTT_MEG\results\PSYCH_ERR_trial1_merge');
% load('PSYCH_RT_lastt_merge');
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_ER_MT_MEG_PSYCHO_merge_1st'])
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_ER_MT_MEG_PSYCHO_merge_1st')
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_ER_MT_MEG_PSYCHO_merge_1st'])
...
load('C:\MTT_MEG\results\PSYCH_ERR_last_merge');
...
print('-dpng',['C:\MTT_MEG\results\AVG_MEAN_ER_MT_MEG_PSYCHO_merge_last'])
...
print('-dpng','C:\MTT_MEG\results\AVG_REGRESS_TIME_ER_MT_MEG_PSYCHO_merge_last')
...
print('-dpng',['C:\MTT_MEG\results\AVG_REGRESS_SPACE_ER_MT_MEG_PSYCHO_merge_last'])
...
subplot(2,2,1)
bar([coef3(1:3) ],'facecolor',[0.5 0.5 0.5]); ylabel('lin slope')
set(gca,'xtick',1:3,'xticklabel',{'Past';'Present';'Future'}); 
subplot(2,2,2)
bar([coef3(4:6) ],'facecolor',[0.5 0.5 0.5]); ylabel('lin slope')
set(gca,'xtick',1:3,'xticklabel',{'West';'Paris';'East'}); 
subplot(2,2,3)
bar([coef4(1:3) ],'facecolor',[0.5 0.5 0.5]); ylabel('log slope')
set(gca,'xtick',1:3,'xticklabel',{'Past';'Present';'Future'}); 
subplot(2,2,4)
bar([coef4(4:6) ],'facecolor',[0.5 0.5 0.5]); ylabel('log slope')
set(gca,'xtick',1:3,'xticklabel',{'West';'Paris';'East'}); 
