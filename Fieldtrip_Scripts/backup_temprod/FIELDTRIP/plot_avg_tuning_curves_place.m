...
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\place_fund_tuning_curve_mags.png')
...
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\place_fund_tuning_curve_grads1.png')
...
set(gca,'FontSize',30); axis([log(40) log(800) 0 2.e-25]); xticklabel_rotate([],45,[],'Fontsize',30)
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\place_fund_tuning_curve_grads2.png')
...
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\place_sha_tuning_curve_mags.png')
...
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\place_sha_tuning_curve_grads1.png')
...
set(gca,'FontSize',30); axis([log(40) log(800) 0 4.e-25]); xticklabel_rotate([],45,[],'Fontsize',30)
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\place_sha_tuning_curve_grads2.png')
