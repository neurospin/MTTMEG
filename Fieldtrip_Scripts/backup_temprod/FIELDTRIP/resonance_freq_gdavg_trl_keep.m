function resonance_freq_gdavg_trl_keep(nip,varargin)
...
for f = 1:length(freqvalues)
    ...
    save(['C:\RESONANCE_MEG\DATA\' nip '\freq\Mags_freqsub_' num2str(freqvalues(f)) '_stimfreq_keep.mat'],'FREQSUB')
...
for f = 1:length(freqvalues)
    ...
    save(['C:\RESONANCE_MEG\DATA\' nip '\freq\Grads1_freqsub_' num2str(freqvalues(f)) '_stimfreq_keep.mat'],'FREQSUB')
...
for f = 1:length(freqvalues)
    ...
    save(['C:\RESONANCE_MEG\DATA\' nip '\freq\Grads2_freqsub_' num2str(freqvalues(f)) '_stimfreq_keep.mat'],'FREQSUB')
...
for f = 1:length(freqvalues)
    ...
    save(['C:\RESONANCE_MEG\DATA\' nip '\freq\Mags_freqsub_' num2str(freqvalues(f)) '_baseline_keep.mat'],'FREQbSUB')
...
for f = 1:length(freqvalues)
    ...
    save(['C:\RESONANCE_MEG\DATA\' nip '\freq\Grads1_freqsub_' num2str(freqvalues(f)) '_baseline_keep.mat'],'FREQbSUB')
...
for f = 1:length(freqvalues)
    ...
    save(['C:\RESONANCE_MEG\DATA\' nip '\freq\Grads2_freqsub_' num2str(freqvalues(f)) '_baseline_keep.mat'],'FREQbSUB')
