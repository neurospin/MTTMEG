...
plot(log([50 83.3 100 150 200 300 400 600]),mean(TFF_face_mean{1,1}),'Color','k','linewidth',6,'marker','o','markerfacecolor','w','Markersize',15);hold on;

% grads1 fund tuning curve
errorbar(log([50 83.3 100 150 200 300 400 600]),mean(TFF_face_mean{1,2}),std(TFF_face_mean{1,2})/sqrt(5),'r','linestyle','none','linewidth',3); hold on;
plot(log([50 83.3 100 150 200 300 400 600]),mean(TFF_face_mean{1,2}),'Color','r','linewidth',6,'marker','o','markerfacecolor','w','Markersize',15); hold on;

% grads2 fund tuning curve
errorbar(log([50 83.3 100 150 200 300 400 600]),mean(TFF_face_mean{1,3}),std(TFF_face_mean{1,3})/sqrt(5),'g','linestyle','none','linewidth',3); hold on;
plot(log([50 83.3 100 150 200 300 400 600]),mean(TFF_face_mean{1,3}),'Color','g','linewidth',6,'marker','o','markerfacecolor','w','Markersize',15);
hold on; legend('Mags','Grads1','Grads2');
...
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\face_fund_tuning_curve_grads2_v2.png')
...
plot(log([50 83.3 100 150 200 300 400 600]),mean(TSF_face_mean{1,1}),'Color','k','linewidth',6,'marker','o','markerfacecolor','w','Markersize',15);
hold on; title('MAGS','FontSize',30);
set(gca,'xtick',log([50 83.3 100 150 200 300 400 600]),'xticklabel',[50 83.3 100 150 200 300 400 600],'LineWidth',3)
set(gca,'FontSize',30); axis([log(40) log(800) 0 8.e-28]); xticklabel_rotate([],45,[],'Fontsize',30)
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\face_sha_tuning_curve_mags_v2.png')
...
plot(log([50 83.3 100 150 200 300 400 600]),mean(TSF_face_mean{1,2}),'Color','k','linewidth',6,'marker','o','markerfacecolor','w','Markersize',15);
hold on; title('GRADS1','FontSize',30);
set(gca,'xtick',log([50 83.3 100 150 200 300 400 600]),'xticklabel',[50 83.3 100 150 200 300 400 600],'LineWidth',3)
set(gca,'FontSize',30); axis([log(40) log(800) 0 4.e-25]); xticklabel_rotate([],45,[],'Fontsize',30)
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\face_sha_tuning_curve_grads1_v2.png')
...
plot(log([50 83.3 100 150 200 300 400 600]),mean(TSF_face_mean{1,3}),'Color','k','linewidth',6,'marker','o','markerfacecolor','w','Markersize',15);
hold on; title('GRADS2','FontSize',30);
set(gca,'xtick',log([50 83.3 100 150 200 300 400 600]),'xticklabel',[50 83.3 100 150 200 300 400 600],'LineWidth',3)
set(gca,'FontSize',30); axis([log(40) log(800) 0 4.e-25]); xticklabel_rotate([],45,[],'Fontsize',30)
ylabel('power +- SE'); set(gca,'FontSize',30); xlabel('frame length (ms)'); set(gca,'Box','off')
print('-dpng','C:\RESONANCE_MEG\DATA\across_sub\face_sha_tuning_curve_grads2_v2.png')
...
errorbar([0.8 1 1.2 1.8 2 2.2 2.8 3 3.2],[M_peak_face_fund_mags   M_peak_face_fund_grads1   M_peak_face_fund_grads2 ...
     ...
     S_peak_object_fund_mags   S_peak_object_fund_grads1   S_peak_object_fund_grads2],'linewidth',3,'color','k','linestyle','none')
...
errorbar([0.8 1 1.2 1.8 2 2.2 2.8 3 3.2],[M_peak_face_sha_mags   M_peak_face_sha_grads1   M_peak_face_sha_grads2 ...
     ...
     S_peak_object_sha_mags   S_peak_object_sha_grads1   S_peak_object_sha_grads2],'linewidth',3,'color','k','linestyle','none')
set(gca,'box','off','linewidth',3) 
ylabel('pic (ms)','fontsize',30) 
set(gca,'xtick',[1 2 3],'xticklabel',{'visages','scènes','objets'},'fontsize',30) 
axis([0.5 3.5 0 250]) 
...
file = ['C:\RESONANCE_MEG\DATA\for_R\peaks.txt'];
fileID = fopen(file,'w');
...
% write results in a text file
file = ['C:\RESONANCE_MEG\DATA\for_R\SSRP.txt'];
fileID = fopen(file,'w');
