...
freqest2               = freqest;
freqest2.powspctrm     = freqest2.powspctrm;
freqest2.freq          = freqest2.freq;
...
freqrep2               = freqrep;
freqrep2.powspctrm     = freqrep2.powspctrm;
freqrep2.freq          = freqrep2.freq;
...
print('-dpng',[root '/DATA/NEW/FIG_THESIS\FIGTHESIS_SPECTRUM_ESTREP' num2str(RunArray(1),'%02i') ...
        '-' num2str(RunArray(2),'%02i')  '_' subject '_0.5-45Hz.png'])
