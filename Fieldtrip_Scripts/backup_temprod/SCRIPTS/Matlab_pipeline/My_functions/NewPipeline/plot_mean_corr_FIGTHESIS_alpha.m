...
for chan = 1:3
    ...
    axis([0 11 -0.3 0.5]); ylabel('Corrélation +- SEM : puissance vs MedDev','fontsize',30)
    set(gca,'box','off','linewidth',3);
    set(gca,'Xtick',1:10,'Xticklabel',{'s04','s05','s06','s07','s08','s10','s11','s12','s13','s14'},'fontsize',30);
    ...
    axis([0 11 -0.3 0.5]); ylabel('Corrélation +- SEM : puissance vs Acc','fontsize',30)
    set(gca,'box','off','linewidth',3);
    set(gca,'Xtick',1:10,'Xticklabel',{'s04','s05','s06','s07','s08','s10','s11','s12','s13','s14'},'fontsize',30);
...
for chan = 1:3
    ...
    axis([0 6 -0.3 0.5]); ylabel('Corrélation +- SEM : puissance vs Durée','fontsize',30)
    set(gca,'box','off','linewidth',3);
...
for chan = 1:3
    ...
    axis([0 5 -0.3 0.5]); ylabel('Corrélation +- SEM : puissance vs Durée','fontsize',30)
    set(gca,'box','off','linewidth',3);
    set(gca,'Xtick',1:10,'Xticklabel',{'s10','s11','s12','s13','s14'},'fontsize',30);
