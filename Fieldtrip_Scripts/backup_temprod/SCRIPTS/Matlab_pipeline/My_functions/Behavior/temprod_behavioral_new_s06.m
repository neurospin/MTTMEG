...
%% set parameters %%
DataDir             = '/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Trans_sss_s06/';
RunNum              = [1 2 3 4];
fsample             = 1000;

%% main script
for i               = RunNum
    DATASETS{i}     = [DataDir 's06_run' num2str(RunNum(i)) '_raw_sss.fif'];
...
CI = [1 2 3 4];                % ascending order of targeted durations
TD = [6.5 8.5 6.5 8.5];         % targeted durations
...
subplot(4,4,14); plot([1 2 1 2],meAn(1:4),'marker','o','linestyle','none'); ylabel('mean'); axis([0 3 4 10]);
hold on 
errorbar([1 2 1 2],meAn(1:4),SD(1:4),'linestyle','none')
subplot(4,4,15); plot([1 2 1 2],meAnnorm(1:4),'marker','o','linestyle','none'); ylabel('std/mean'); axis([0 3 0 0.4])
