function datapath = temprod_preproc(run,isdownsample,subject,runref,rejection,tag)
...
% par.badch              = '0543 1722 1723 1741 1233 2343';
par.pcapath            = [root '\DATA\NEW\Trans_sss_' subject '/'];
