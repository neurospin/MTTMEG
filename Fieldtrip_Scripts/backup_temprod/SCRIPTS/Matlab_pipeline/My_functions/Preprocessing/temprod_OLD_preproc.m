...
if length(par.run)     == 2
    ...
    data2              = ns_fif2ft_temprod_OLD(par2);
    cfg                = [];
    cfg.resamplefs     = 500;
    cfg.detrend        = 'no';
    cfg.blc            = 'no';
...
% data_part1 = data; l = length(data.trial);
% data_part2 = data;
% data_part3 = data;
% 
% data_part1.time = data_part1.time(1,1:60); 
% data_part2.time = data_part2.time(1,61:120); 
% data_part3.time = data_part3.time(1,121:l); 
% 
% data_part1.trial = data_part1.trial(1,1:60); 
% data_part2.trial = data_part2.trial(1,61:120); 
% data_part3.trial = data_part3.trial(1,121:l); 
% 
% datapath               = [par.ProcDataDir 'run' num2str(newnumber) '_part1.mat'];
% save(datapath,'data_part1','par','-v7.3');
% datapath               = [par.ProcDataDir 'run' num2str(newnumber) '_part2.mat'];
% save(datapath,'data_part2','par','-v7.3');
% datapath               = [par.ProcDataDir 'run' num2str(newnumber) '_part3.mat'];
% save(datapath,'data_part3','par','-v7.3');
