function datapath = temprod_OLD_preproc_uniquetrial(run,isdownsample,subject,runref,rejection,newnumber)
...
%% trial definition %%
par.photodelay         = 0.00;
par.trialfun           = 'trialfun_temprod_OLD_uniquetrial';
