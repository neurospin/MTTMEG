function ns_getheadmv_temprod_OLD(par)
...
fprintf(fd2, ['ls ' par.Sub_Num '_run$i*_raw.fif\n']);
fprintf(fd2, ['show_fiff -vt 222 '  par.Sub_Num '_run$i*_raw.fif > ' par.DirHead 'Pos_$Subject"_run"$i.txt\n']);
fprintf(fd2, 'end\n');
fclose(fd2);
