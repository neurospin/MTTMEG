function datapath = temprod_preproc_ICA(run,isdownsample,subject,runref,rejection)
...
durinfopath = [par.ProcDataDir 'FT_trials/runICA' num2str(run(1)) 'durinfo.mat'];
...
for i = 1:length(datasave.time)
    ...
    datapath               = [par.ProcDataDir 'FT_trials/runICA' num2str(run(1)) 'trial' num2str(i,'%03i') '.mat'];
