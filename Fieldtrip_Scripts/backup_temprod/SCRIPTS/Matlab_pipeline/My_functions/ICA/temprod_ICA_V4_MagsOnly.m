function temprod_ICA_V4_MagsOnly(index,subject,freqband,method,numcomponent,show)
...
freqcomppath           = [par.ProcDataDir '/FT_ICs/runica-comp' num2str(numcomponent) 'V4_MagsOnly_freq' num2str(index) '.mat'];
...
if show == 1
    for i = 1:numcomponent
        ...
        mysubplot(8,8, i*4 - 1)
        cfg.comment = [subject ' r' num2str(index) 'Mags comp' num2str(i)];
        cfg.electrodes = 'off';
...
print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
    '/ICAV4_MagsOnly_topo_overview_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '_' num2str(numcomponent) 'comp.png']);
...
if show == 1
    ...
    ylabel('log Power')
    xlabel('frequency (Hz)')
    title([subject ' run : ' num2str(index) 'Mags Components Mean power Spectrm averaged across trials'])
...
print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
    '/ICAV4_MagsOnly_overview_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '_' num2str(numcomponent) 'comp.png']);
...
print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
    '/ICAV4_MagsOnly_individual_comps_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '_' num2str(numcomponent) 'comp.png']);
