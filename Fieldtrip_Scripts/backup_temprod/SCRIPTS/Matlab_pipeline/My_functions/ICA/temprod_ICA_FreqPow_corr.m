function temprod_ICA_FreqPow_corr(indexrun,subject,numcomponent,fsample,freqbandview)
...
print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/ICA_Corr_' num2str(numcomponent) '_' num2str(freqbandview(1)) '-' num2str(freqbandview(2)) '_' num2str(indexrun) '_' num2str(numcomponent) 'comp.png']);
