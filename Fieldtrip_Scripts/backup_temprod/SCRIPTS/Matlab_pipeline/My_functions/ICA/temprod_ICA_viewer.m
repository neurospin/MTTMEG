function temprod_ICA_viewer(indexrun,subject,numcomponent,freqbandview,method)
...
load([par.ProcDataDir 'FT_ICs/' method '-comp' num2str(numcomponent) 'V5_freq' num2str(indexrun) '.mat']);
C = colormap(jet(30));
