function temprod_ICA_globalview_v3(index,subject,method,threshold,freqband,K,show)
...
load([par.ProcDataDir 'FT_ICs/runica-comp' num2str(numcomponent) 'V3_freq' num2str(indexrun) '.mat']);
