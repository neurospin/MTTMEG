function temprod_ICA_V2(index,subject,bandpass,bandpasstag,freqband,K,method,numcomponent,show)
...
freqcomppath           = [par.ProcDataDir '/FT_ICs/runica-comp' num2str(numcomponent) '_freq' num2str(index) '.mat'];
...
if show == 1
    ...
    print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/ICA_overview_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '_' num2str(numcomponent) 'comp' '.png']);
