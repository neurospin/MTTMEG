function [PKSbis,LOCbis] = temprod_dataviewer_var_EEG(indexes,subject,freqband,debiasing,loglogdetrend,datatoplot,mode,savetag)
...
for k = 1:length(indexes)
    ...
    title(['EEG' subject ' : intertrial power ' datatoplot ])
    xlabel('frequency (Hz)')
    ylabel('log-power')
    grid('on')
