function appendspectra_tetha(index,subject,zscoretag,K)
...
for j = 1:3
    ...
    if zscoretag == 1
        print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
            '/Fullspctrm_zscores_chan_by_chan_theta' chantype '_' num2str(index) '.png']);
    else
        print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
            '/Fullspctrm_chan_by_chan_theta' chantype '_' num2str(index) '.png']);
    end
...
if zscoretag == 1
    print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/Fullspctrm_zscores_image_theta' num2str(index) '.png']);
else
    print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/Fullspctrm_image_theta' num2str(index) '.png']);
end
