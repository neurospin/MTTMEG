...
for clustind = 1:5
    ...
    for j = 1:3
        ...
        for k = 1:length(arrayindex)
            ...
            %% select channels cluster-wise
            eval(['data' num2str(k) '.Part1Freq{1,' num2str(j) '}.powspctrm ='...
                'data' num2str(k) '.Part1Freq{1,' num2str(j) '}.powspctrm(:,indsel(' num2str(j) '),fband);'])
            eval(['data' num2str(k) '.Part2Freq{1,' num2str(j) '}.powspctrm ='...
                'data' num2str(k) '.Part2Freq{1,' num2str(j) '}.powspctrm(:,indsel(' num2str(j) '),fband);'])
            eval(['data' num2str(k) '.Part3Freq{1,' num2str(j) '}.powspctrm ='...
                'data' num2str(k) '.Part3Freq{1,' num2str(j) '}.powspctrm(:,indsel(' num2str(j) '),fband);'])
            eval(['data' num2str(k) '.Part4Freq{1,' num2str(j) '}.powspctrm ='...
                'data' num2str(k) '.Part4Freq{1,' num2str(j) '}.powspctrm(:,indsel(' num2str(j) '),fband);'])            
