function P = temprod_freqslope_EEG(index,subject,freqband,savetag)
...
if savetag == 1
    print('-dpng',['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/FullspctrmEEG_slope_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
    savepath = ['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/processed_' subject '/FT_spectra/EEGcorrslope' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) ];
