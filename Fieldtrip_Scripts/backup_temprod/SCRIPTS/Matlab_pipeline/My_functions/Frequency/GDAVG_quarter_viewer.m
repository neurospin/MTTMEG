...
for i = 1:length(subjects)
    ...
    % load data
    datapath               = TheSlasher([Dir '/FT_spectra/QuarterCutFreqGAVG_' cond '_1-120_V2.mat'],tag);
...
elseif size(Q1FPowAllSub_mags,1) == 1
 ...
 % AVG MAGs
    ...
    print('-dpng',TheSlasher([root '/DATA/NEW/across_subjects_plots' ...
        '/Spectra_quarter_' cond '_' num2str(freqbandselect(1)) '-' num2str(freqbandselect(2)) '_GAVG_nodetrend_V2_' condsub '.png'],tag));
