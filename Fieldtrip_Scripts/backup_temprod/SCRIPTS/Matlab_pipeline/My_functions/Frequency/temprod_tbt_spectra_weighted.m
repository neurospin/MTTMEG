function temprod_tbt_spectra_weighted(index,subject,freqband,savetag,nbwin,overlap)
...
if savetag == 1
    print('-dpng',['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/Fullspctrm_ovlp' num2str(overlap) num2str(nbwin) 'win_' chantype num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
end
