function temprod_dataviewer_jrcw(index,subject,freqband,K,debiasing,interpnoise,chandisplay,savetag,tag)
...
for j = 1:3
    ...
    Fullspctrm_path     = [DIR 'FT_spectra/Fullspctrm_jrcw_' chantype num2str(index) '.mat'];
    ...
    if chandisplay == 1
        ...
        if savetag == 1
            print('-dpng',[root '/DATA/NEW/Plots_' subject...
                '/Fullspctrm_jrcw_' chantype '_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
        end
        ...
        if savetag == 1
            print('-dpng',[root '/DATA/NEW/Plots_' subject...
                '/Fullspctrm_zscores_jrcw_' chantype '_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
        end
    end
...
if savetag == 1
    print('-dpng',[root '/DATA/NEW/Plots_' subject...
        '/Fullspctrm_overview_jrcw_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
end
