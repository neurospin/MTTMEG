function [freqref,data_output] = GDAVG_half_viewer_v3(subjects,freqbandselect,cond,tag)
...
for i = 1:length(subjects)
    ...
    % load data
    datapath               = TheSlasher([Dir '/FT_spectra/Short&LongFreqGAVG_' cond '_1-120_nodetrend.mat'],tag);
...
elseif size(SFPowAllSub_mags,1) == 1
    ...
    print('-dpng',TheSlasher([root '/DATA/NEW/across_subjects_plots' ...
        '/Spectra_Half_' cond '_' num2str(freqbandselect(1)) '-' num2str(freqbandselect(2)) '_GAVG_nodetrend_' condsub '.png'],tag));
