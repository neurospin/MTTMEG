function P = temprod_freqslope_weighted(index,subject,freqband,savetag,nbwin,overlap)
...
for j = 1:3
    ...
    Fullspctrm_path     = [DIR 'FT_spectra/Fullspctrm_ovlp' num2str(overlap) num2str(nbwin) 'win_' chantype num2str(index) '.mat'];
...
if savetag == 1
    print('-dpng',['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/Fullspctrm_slope_ovlp' num2str(overlap) num2str(nbwin) 'win_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
    savepath = ['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/processed_' subject '/FT_spectra/corrslope_ovlp' num2str(overlap) num2str(nbwin) 'win_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) ];
