function appendspectra_alpha(index,subject,zscoretag,K)
...
for j = 1:3
    ...
    Fullspctrm_path     = [par.ProcDataDir 'Fullspctrm_alpha' chantype num2str(index) '.mat'];
    ...
    if zscoretag == 1
        print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
            '/Fullspctrm_zscores_chan_by_chan_alpha' chantype '_' num2str(index) '.png']);
    else
        print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
            '/Fullspctrm_chan_by_chan_alpha' chantype '_' num2str(index) '.png']);
    end
...
if zscoretag == 1
    print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/Fullspctrm_zscores_image_alpha' num2str(index) '.png']);
else
    print('-dpng',['/neurospin/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/Fullspctrm_image_alpha' num2str(index) '.png']);
end
