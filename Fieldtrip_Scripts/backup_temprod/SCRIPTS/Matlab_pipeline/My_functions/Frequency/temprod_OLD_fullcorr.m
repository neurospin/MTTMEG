%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function temprod_OLD_fullcorr(index,ptreshold,subject)
...
for j = 1:3
    ...
    set(sub,'XTick',6:50:length(Fullfreq),'XTickLabel',Fullfreq(6:50:end));
    colorbar
    sub = subplot(2,3,j+3)
    ...
    ylabel('channels'); xlabel('frequency'); title([chantype ': T-test at ' num2str(ptreshold)]);
    set(sub,'XTick',6:50:length(Fullfreq),'XTickLabel',Fullfreq(6:50:end));
end
