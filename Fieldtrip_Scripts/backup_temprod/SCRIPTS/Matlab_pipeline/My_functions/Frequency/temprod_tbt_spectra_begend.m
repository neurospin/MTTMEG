function temprod_tbt_spectra_begend(index,subject,freqband,savetag)
...
for j = 1:3
    ...
    Fullspctrm_path     = [DIR 'FT_spectra/FullspctrmbegendV2_' chantype num2str(index) '.mat'];
...
if savetag == 1
    print('-dpng',['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject...
        '/Fullspctrm_tbt_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
end
