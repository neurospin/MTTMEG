function [ShortFreqGAVG,LongFreqGAVG] = temprod_freqGDAVG_half_v2(arrayindex,subject,freqband,cond,tag)
...
if length(arrayindex) == 1
    ...
    for j = 1:3
        ...
        load([Dir '/FT_spectra/Short&LongFreq_1-120_' num2str(arrayindex(1)) '_V2.mat'])
