function temprod_dataviewer_accuracy(index,subject,freqband,K,debiasing,interpnoise,chandisplay,target,savetag,tag)
...
for j = 1:3
    ...
    asc_ord             = asc_ord + [ -ones(length(asc_ord),1)*target zeros(length(asc_ord),1) zeros(length(asc_ord),1)];
    ...
    if chandisplay == 1
        ...
        if savetag == 1
            print('-dpng',[root '/DATA/NEW/Plots_' subject...
                '/Fullspctrm_accuracy_' chantype '_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
        end
        ...
        if savetag == 1
            print('-dpng',[root '/DATA/NEW/Plots_' subject...
                '/Fullspctrm_zscores_accuracy_' chantype '_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
        end
    end
...
if savetag == 1
    print('-dpng',[root '/DATA/NEW/Plots_' subject...
        '/Fullspctrm_overview_accuracy_' num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(index) '.png']);
end
