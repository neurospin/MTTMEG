function [ShortFreq,LongFreq] = temprod_freqanalysis_half_v3(run,subject,Pad,freqband,tag)
...
datapath               = [Dir '/FT_spectra/Short&LongFreq_' ...
    num2str(freqband(1)) '-' num2str(freqband(2)) '_' num2str(run) '_nodetrend.mat'];
