%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function temprod_OLD_GFP_overview2(subject,freqband)
...
for k = 1:6
    ...
    subplot(3,6,k);
    imagesc(log(freq.powspctrm(1:3:306,:)));
%     set(sub1, 'XTick',l,'XTickLabel',freq.freq(l))
%     colorbar
    subplot(3,6,k+6);
    imagesc(log(freq.powspctrm(2:3:306,:)));
%     set(sub2, 'XTick',l,'XTickLabel',freq.freq(l))
%     colorbar
    subplot(3,6,k+12);
    imagesc(log(freq.powspctrm(3:3:306,:)));
