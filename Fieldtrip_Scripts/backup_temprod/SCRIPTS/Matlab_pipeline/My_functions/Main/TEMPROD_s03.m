...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
temprod_preproc_jr([1 11],'s03',1,'ecg&eog',tag)
temprod_preproc_jr(2     ,'s03',1,'ecg&eog',tag)
temprod_preproc_jr([3 31],'s03',1,'ecg&eog',1,tag)
temprod_preproc_jr(4     ,'s03',1,'ecg_only',tag)
temprod_preproc_jr(5     ,'s03',1,'ecg_only',tag)
temprod_preproc_jr(6     ,'s03',1,'ecg&eog',tag)
...
temprod_dataviewer_var_half([1],'s03',[1 50],0,0,'MEAN','old',1);
temprod_dataviewer_var_half([1],'s03',[1 50],0,0,'STD','old',1);
temprod_dataviewer_var_half([2],'s03',[1 50],0,0,'MEAN','old',1);
temprod_dataviewer_var_half([2],'s03',[1 50],0,0,'STD','old',1);
temprod_dataviewer_var_half([3],'s03',[1 50],0,0,'MEAN','old',1);
temprod_dataviewer_var_half([3],'s03',[1 50],0,0,'STD','old',1);
temprod_dataviewer_var_half([4],'s03',[1 50],0,0,'MEAN','old',1);
temprod_dataviewer_var_half([4],'s03',[1 50],0,0,'STD','old',1);
temprod_dataviewer_var_half([5],'s03',[1 50],0,0,'MEAN','old',1);
temprod_dataviewer_var_half([5],'s03',[1 50],0,0,'STD','old',1);
temprod_dataviewer_var_half([6],'s03',[1 50],0,0,'MEAN','old',1);
temprod_dataviewer_var_half([6],'s03',[1 50],0,0,'STD','old',1);
temprod_dataviewer_var_half([7],'s03',[1 50],0,0,'MEAN','old',1);
temprod_dataviewer_var_half([7],'s03',[1 50],0,0,'STD','old',1);
...
temprod_freqslope(1,'s03',[1 4],1)
temprod_freqslope(2,'s03',[1 4],1)
temprod_freqslope(3,'s03',[1 4],1)
temprod_freqslope(4,'s03',[1 4],1)
temprod_freqslope(5,'s03',[1 4],1)
temprod_freqslope(6,'s03',[1 4],1)
temprod_freqslope(1,'s03',[1 7],1)
temprod_freqslope(2,'s03',[1 7],1)
temprod_freqslope(3,'s03',[1 7],1)
temprod_freqslope(4,'s03',[1 7],1)
temprod_freqslope(5,'s03',[1 7],1)
temprod_freqslope(6,'s03',[1 7],1)
temprod_freqslope(1,'s03',[4 7],1)
temprod_freqslope(2,'s03',[4 7],1)
temprod_freqslope(3,'s03',[4 7],1)
temprod_freqslope(4,'s03',[4 7],1)
temprod_freqslope(5,'s03',[4 7],1)
temprod_freqslope(6,'s03',[4 7],1)
temprod_freqslope(1,'s03',[30 80],1)
temprod_freqslope(2,'s03',[30 80],1)
temprod_freqslope(3,'s03',[30 80],1)
temprod_freqslope(4,'s03',[30 80],1)
temprod_freqslope(5,'s03',[30 80],1)
temprod_freqslope(6,'s03',[30 80],1)
temprod_freqslope(1,'s03',[30 120],1)
temprod_freqslope(2,'s03',[30 120],1)
temprod_freqslope(3,'s03',[30 120],1)
temprod_freqslope(4,'s03',[30 120],1)
temprod_freqslope(5,'s03',[30 120],1)
temprod_freqslope(6,'s03',[30 120],1)
