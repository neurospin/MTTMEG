...
temprod_new_dataviewer(1,'s06',[15 30],[1 2 3 4 3 2 1],0,0)
temprod_new_dataviewer(2,'s04',[8 14],[1 2 3 2 1],1,1)
temprod_new_dataviewer(3,'s04',[8 14],[1 2 3 2 1],1,1)
temprod_new_dataviewer(4,'s04',[8 14],[1 2 3 2 1],1,1)
...
% new version
freqband  = {[4 8];[8 14];[15 30];[30 48.9]};
for k = 1:length(freqband)
    for i = 1;
