...
function temprod_4nut_v1
%% ------------------------------------------------------------------------
% ------------------ ENTER VARIABLES HERE ---------------------------------
% -------------------------------------------------------------------------
%setpath
addpath('/neurospin/local/mne/MNE-2.7.0-3089-Linux-x86_64/share/matlab'); 
addpath('/neurospin/local/fieldtrip/','-end')
...
%             };
%
fname = { 's03_b1d6_raw_trans_sss.fif'...
          's03_b1d6_raw-1_trans_sss.fif'...
          's03_b2d1_raw_trans_sss.fif'...
          's03_b3d5_raw_trans_sss.fif'...
          's03_b3d5_raw-1_trans_sss.fif'...
          's03_b4d3_raw_trans_sss.fif'...
          's03_b5d2_raw-1_trans_sss.fif'...
          's03_b6d4_raw_trans_sss.fif'...
          's03_b7_rest_raw_trans_sss.fif'...
          's03_b8_rndpress_raw_trans_sss.fif'};
