function temprod_processing_v2
...
elseif strfind(fname{f},'press'); dur = 'rndress';
end;

% ----------------- start saving
save([sid,'_',dur,'_ICA.mat']);
...
%cfg.channel         = {'MEG*1'};
%cfg.channel         = {'MEG*2','MEG*3' };
raw_epochs_mAR      = rejectvisual(cfg,raw_epochs);1
for t = 1:length(raw_epochs_mAR.trial); plot(raw_epochs_mAR.trial{t}(307,:)); hold on ; pause; hold off;end;hold off;
% EOG62
for t = 1:length(raw_epochs_mAR.trial); plot(raw_epochs_mAR.trial{t}(308,:)); hold on ; pause; hold off;end;hold off;
% ECG
for t = 1:length(raw_epochs_mAR.trial); plot(raw_epochs_mAR.trial{t}(309,:)); hold on ; pause; hold off;end;hold off;
% ----
save([sid,'_',dur,'_ICA.mat'],'raw_epochs_mAR','-append');
% ----
...
%
save([sid,'_',dur,'_ICA.mat'],'data','comp*meg','-append');
...
save([sid,'_',dur,'_ICA.mat'],'cfg','artifact_*','-append');
% ---
...
%
save([sid,'_',dur,'_mag_ICA.mat'], 'data*ecg','-append');
% ---
...
save([sid,'_',dur,'_ICA.mat'], 'comp*ecg','-append');
% ---
...
%
save([sid,'_',dur,'_ICA.mat'], 'timelock*ecg','-append');
% ---
...
save([sid,'_',dur,'_ICA.mat'], 'comp_*_meg_orig','-append');
