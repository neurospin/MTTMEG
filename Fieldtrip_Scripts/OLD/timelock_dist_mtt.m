function timelock_dist_mtt(nip)

% define channel types
[Grads1,Grads2,Mags]   = grads_for_layouts('Laptop');

clear datafilt40
load(['C:\MTT_MEG\data\' nip '\processed\PastClose.mat']);
...
%% T2
clear datafilt40
load(['C:\MTT_MEG\data\' nip '\processed\PastFar.mat']);
...
%% T3
clear datafilt40
load(['C:\MTT_MEG\data\' nip '\processed\PresentClose.mat']);
...
%% S1
clear datafilt40
load(['C:\MTT_MEG\data\' nip '\processed\PresentFar.mat']);
...
%% S2
clear datafilt40
load(['C:\MTT_MEG\data\' nip '\processed\FutureClose.mat']);
...
%% S3
clear datafilt40
load(['C:\MTT_MEG\data\' nip '\processed\FutureFar.mat']);
...
save(['C:\MTT_MEG\data\' nip '\processed\Grads2_DIST_lock.mat'], ...
