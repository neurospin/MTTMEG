...
save(['C:\MTT_MEG\data\' nip '\processed\TSCue_Time_filt40_' run '.mat'],'data')
...
cfg1.dataset                 = [root run '_trans_sss.fif'];
cfg1.trialfun                = 'trialfun_mtt_cue_space_v2';
...
save(['C:\MTT_MEG\data\' nip '\processed\TSCue_Space_filt40_' run '.mat'],'data')
...
save(['C:\MTT_MEG\data\' nip '\processed\TSCue_Time_nofilt_' run '.mat'],'data')
...
save(['C:\MTT_MEG\data\' nip '\processed\TSCue_Space_nofilt_' run '.mat'],'data')
