...
% fmult
fmult = 1e14; % for express in fTesla rather than Tesla
% cluster shade
plot_clustshade(clust,alpha, stat, -50, 80,[0.9 0.9 0.9])

% define axes limit and plot properties
set_axes(-0.7, 5, ceil(valmin*fmult), ceil(valmax*fmult))
...
fmult = 1e14; % for express in fTesla rather than Tesla
% cluster shade
plot_clustshade(clust,alpha, stat, ceil(valmin*fmult), ceil(valmax*fmult),[0.9 0.9 0.9])
% define axes limit and plot properties
set_axes(-0.7, 5, ceil(valmin*fmult), ceil(valmax*fmult))
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/grad_counterplot_timecourse')
...
data = barplotval(GDAVGt,alpha,stat,index,graphcolor,[0.3 3.7 -30 30],fmult);
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/grad_counterplot_barplot')
...
write_csv_for_anova_R(DataMat, CondNames, [datafolder '/Grads1_SREF_clustTREF'])
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/panel/avg_cluster_grad_counter')
