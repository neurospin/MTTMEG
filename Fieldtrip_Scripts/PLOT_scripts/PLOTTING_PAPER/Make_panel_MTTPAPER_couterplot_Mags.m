...
if strcmp(clusttype,'negclust')
    load(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/spatial_clust_from_mne/stats_negclust_' ...
       'F_' num2str(clustnum) '_' cdn_clust '_' chansel '_Lat' num2str(latency(1)) '-' num2str(latency(2))...
...
cfg.comment            = num2str(stat.time(index));
ft_topoplotER(cfg,statdummy);
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/dummytopo_mags_small')
...
% cluster shade
[list_start, list_end] = plot_clustshade(clust,alpha, stat,-3,3,[0.9 0.9 0.9])
...
fmult = 1e14; % for express in fTesla rather than Tesla
% cluster shade
plot_clustshade(clust,alpha, stat, -3,3,[0.9 0.9 0.9])
% define axes limit and plot properties
set_axes(-0.7, 5, -3,3)
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/mags_counterplot_barplot')
...
write_csv_for_anova_R(DataMat, CondNames, [datafolder '/Mags1_SREF_clustTREF'])
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/panel/avg_cluster_mag2_counter')
