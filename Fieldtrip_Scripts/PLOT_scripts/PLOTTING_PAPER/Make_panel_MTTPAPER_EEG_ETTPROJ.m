...
condnames_clust = {'EtPast';'EtPre';'EtFut'};
latency         = [0 1];
...
cfg.comment            = num2str(stat.time(index));
ft_topoplotER(cfg,stat);
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/ET_TPROJ')
...
write_csv_for_anova_R(DataMat, CondNames, [datafolder '/EEG_SREF_clustTREF'])
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/panel/EEG_ETTPROJ')
