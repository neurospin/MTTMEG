...
cfg.comment            = num2str(stat.time(index));
ft_topoplotER(cfg,stat);
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/ES_SPROJ')
...
% cluster shade
plot_clustshade(clust,alpha, stat,-1,3,[0.9 0.9 0.9])
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/eeg_ESsproj_timecourse')
...
write_csv_for_anova_R(DataMat, CondNames, [datafolder '/EEG_EVS_clustSREF'])
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/panel/EEG_ESSPROJ')
