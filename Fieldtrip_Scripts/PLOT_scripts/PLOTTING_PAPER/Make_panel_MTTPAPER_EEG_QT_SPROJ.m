...
cfg.comment            = num2str(stat.time(index));
ft_topoplotER(cfg,stat);
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/Qt_SPACE_Fmap_EEG')
...
set_axes(-0.7, 1.5, -1.5,2.5)

% stimulus onsets
line([0 0],[-1.5 2.5],'linestyle',':','linewidth',3,'color',[0.5 0.5 0.5]); hold on
line([1 1],[-1.5 2.5],'linestyle',':','linewidth',3,'color',[0.5 0.5 0.5]); hold on
