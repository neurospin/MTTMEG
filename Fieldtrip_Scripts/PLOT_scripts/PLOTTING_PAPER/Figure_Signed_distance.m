...
for index = y
    ...
    cfg.marker             = 'off';
    cfg.highlight          = 'on';
    indchan = []; indchan  = find(stat_grads2s.prob(:,index) <0.05);
    cfg.highlightchannel   = stat_grads2s.label(indchan);
    cfg.highlightsymbol    = '.';
...
plot(stat_grads2s.time,times)
[x,y]    = findpeaks(times);
indchan4 = find(stat_grads2s.prob(:,y(2)) <0.025);
...
% % cluster shade
% fill([0.640 0.640 0.712 0.712], [-50 50 50 -50],[0.8 0.8 0.8],'edgecolor',[0.8 0.8 0.8]);hold on
% fill([0.772 0.772 0.856 0.856], [-50 50 50 -50],[0.8 0.8 0.8],'edgecolor',[0.8 0.8 0.8]);hold on
% fill([0.884 0.884 0.928 0.928], [-50 50 50 -50],[0.8 0.8 0.8],'edgecolor',[0.8 0.8 0.8]);hold on
fill([0.640 0.640 0.928 0.928], [-50 50 50 -50],[0.8 0.8 0.8],'edgecolor',[0.8 0.8 0.8]);hold on
...
% timecourse
plot(GDAVG_grads2s{1}.time,val1,'linewidth',8,'color',[0 0 0.5  ]);hold on
plot(GDAVG_grads2s{1}.time,val2,'linewidth',8,'color',[0.05 0.05   0.75  ]);hold on
plot(GDAVG_grads2s{1}.time,val3,'linewidth',8,'color',[0.1 0.10   1  ]);hold on
plot(GDAVG_grads2s{1}.time,val4,'linewidth',8,'color',[0.25   0.25 1]);hold on
plot(GDAVG_grads2s{1}.time,val5,'linewidth',8,'color',[0.5   0.50 1]);hold on
plot(GDAVG_grads2s{1}.time,val6,'linewidth',8,'color',[0.75   0.75 1]);hold on
...
plot([-40 40],[yy(1) yy(2)],'linewidth',5,'color','k','markersize',18); hold on
