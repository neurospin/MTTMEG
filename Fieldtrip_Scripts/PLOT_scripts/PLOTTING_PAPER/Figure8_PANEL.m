...
%%%%%%%%%%%%%%%%%%%%%%%%%%%% DIST TIME %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
condnames_clust = {'REGfull_distS_Zero'};
condnames    = {'REGfull_distS'};
latency      = [0 1];
...
allD = diag(D)
for i = 1:length(GDAVG_magt)
   plot(dist(i),D(i),'color', 'b','marker','.','markersize',40);hold on
end
% errorbar(1,mean(data1),std(data1)./sqrt(19),'linestyle','none','color','k','linewidth',3)
