...
cfg.comment            = num2str(stat.time(index));
ft_topoplotER(cfg,stat);
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/Qt_SPACE_Fmap_mags_REG_clust1')
...
% cluster shade
plot_clustshade(clust,alpha, stat,-5,5,[0.9 0.9 0.9])

% define axes limit and plot properties
set_axes(-0.7, 1.5, -5,5)

% stimulus onsets
line([0 0],[-10 10],'linestyle',':','linewidth',3,'color',[0.3 0.3 0.3]); hold on
line([1 1],[-10 10],'linestyle',':','linewidth',3,'color',[0.3 0.3 0.3]); hold on
...
write_csv_for_anova_R(DataMat, CondNames, [datafolder '/mag_QSSREF_REG2'])
...
print('-dpng','/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/GROUP/MISC_PLOTS/panel/mag_cluster_QSSREF')
