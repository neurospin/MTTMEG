function TLSL_GROUPlvl_INT_from_mne(niplist,chansel,condnames1,condnames2,latency,graphcolor,stat_test)
...
if strcmp(statstag,'T') == 1
    instr = 'ERFstatT_GroupLvl_INT_from_mne(condnames1, condnames2,GDAVG1, GDAVG1t, GDAVG2, GDAVG2t,chansel,latency,graphcolor,stat_test';
end
instr = [instr ');'];  
eval(instr)
