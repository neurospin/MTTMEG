function TLSL_SUBJlvl_EEG(nip,chansel,condnames,condarray,segwin,latency,PlotColors)
    ...
    for i = 1:size(condarray,2)
        for j = 1:size(condarray{1,i},1)
            datatmp{j,i} = load (['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/'...
                                          nip '/MegData/Processed/' condarray{1,i}{j,1} 'EEG_filt40_clean.mat'],'dataclean40');
