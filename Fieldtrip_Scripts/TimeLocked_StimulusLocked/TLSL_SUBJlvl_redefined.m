function TLSL_SUBJlvl_redefined(nip,chansel,source,source_timing,func,segwin,latency)
...
%% LOCK TIMING ON ANOTHER STIM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%% STEP1: match timings %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
trldef_orig = [];
for i = 1:size(source,1)
    trldef_orig = [trldef_orig ; load(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/'...
        nip '/MegData/Processed_new/' source{i} '_dat_filt40'],'trldef')];
end
trldef_redef = [];
for i = 1:size(source_timing,1)
    trldef_redef = [trldef_redef ; load(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/'...
        nip '/MegData/Processed_new/' source_timing{i} '_dat_filt40'],'trldef')];
end
