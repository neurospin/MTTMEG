function TLSL_GROUPlvl_from_mne_select(niplist,chansel,condnames,selection,latency,graphcolor,test)
...
for i = 1:length(selection)
    ...
    cdn = [cdn condnames{selection(i)} '_'];
...
instr = 'ERFstat_General_from_mne(tmpname, latency, TMP, TMPt, chansel,tmpcolor,test,';
