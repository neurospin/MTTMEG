function TFSL_GROUPlvl_REG(niplist,chansel,condnames,latency,graphcolor,stat_test,foi,isind)
...
instr = 'ERFstat_GeneralTF(condnames, latency, GDAVG, GDAVGt, chansel,graphcolor,stat_test,foi,isind,';
