function TFSL_GROUPlvl_REG4lvl(niplist,chansel,condnames,latency,graphcolor,foi)
...
instr = 'ERFstat_GeneralTF(condnames, latency, GDAVG, GDAVGt, chansel,graphcolor,foi,';
