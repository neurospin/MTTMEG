function TFinducedSL_SUBJlvl_v2(nip,chansel,source,func,segwin,latency)
...
% cfg_plot         = [];
% % cfg_plot.channel = 'MEG2231';
% cfg_plot.zlim         = [-1 1].*1e-25;
% figure;ft_singleplotTFR(cfg_plot,timelockbase{i} )
% figure;ft_singleplotTFR(cfg_plot,timelockbase2{i} )
% figure;ft_singleplotTFR(cfg_plot,timelockbasec{i} )
% figure;ft_singleplotTFR(cfg_plot, datafevk )
% 
% cfg = [];
% ft_multiplotTFR(cfg,timelockbasec{i})
