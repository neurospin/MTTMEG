function [condnames,dataset,dist_val,tag] = make_AVG_signDIST36_EVS_Past_True(datasource,rejectvisual)
...
for i = 1:length(select_event)
    condnames{i} = {['sDS_pas' num2str(dist_val(i))]}
end
