function [condnames,dataset] = make_AVG_SDIST4_EVT(datasource,rejectvisual)
...
TABLE{21,2}     = repmat(EVENTSCODE_PrePar(SD_Par_quartiled == 1)*1000,1,2) + repmat([81 83],size(EVENTSCODE_PrePar(SD_Par_quartiled == 1),1),1);
TABLE{22,2}     = repmat(EVENTSCODE_PasPar(SD_Pas_quartiled == 1)*1000,1,2)+ repmat([101 103],size(EVENTSCODE_PasPar(SD_Pas_quartiled == 1),1),1);
TABLE{23,2}     = repmat(EVENTSCODE_FutPar(SD_Fut_quartiled == 1)*1000,1,2)+ repmat([121 123],size(EVENTSCODE_FutPar(SD_Fut_quartiled == 1),1),1);
TABLE{24,2}     = repmat(EVENTSCODE_PreW(SD_W_quartiled == 1)*1000,1,2)+ repmat([141 143],size(EVENTSCODE_PreW(SD_W_quartiled == 1),1),1);
TABLE{25,2}     = repmat(EVENTSCODE_PreE(SD_E_quartiled == 1)*1000,1,2)+ repmat([161 163],size(EVENTSCODE_PreE(SD_E_quartiled == 1),1),1);

TABLE{26,2}     = repmat(EVENTSCODE_PrePar(SD_Par_quartiled == 2)*1000,1,2) + repmat([81 83],size(EVENTSCODE_PrePar(SD_Par_quartiled == 2),1),1);
TABLE{27,2}     = repmat(EVENTSCODE_PasPar(SD_Pas_quartiled == 2)*1000,1,2)+ repmat([101 103],size(EVENTSCODE_PasPar(SD_Pas_quartiled == 2),1),1);
TABLE{28,2}     = repmat(EVENTSCODE_FutPar(SD_Fut_quartiled == 2)*1000,1,2)+ repmat([121 123],size(EVENTSCODE_FutPar(SD_Fut_quartiled == 2),1),1);
TABLE{29,2}     = repmat(EVENTSCODE_PreW(SD_W_quartiled == 2)*1000,1,2)+ repmat([141 143],size(EVENTSCODE_PreW(SD_W_quartiled == 2),1),1);
TABLE{30,2}   = repmat(EVENTSCODE_PreE(SD_E_quartiled == 2)*1000,1,2)+ repmat([161 163],size(EVENTSCODE_PreE(SD_E_quartiled == 2),1),1);

TABLE{31,2}   = repmat(EVENTSCODE_PrePar(SD_Par_quartiled == 3)*1000,1,2) + repmat([81 83],size(EVENTSCODE_PrePar(SD_Par_quartiled == 3),1),1);
TABLE{32,2}   = repmat(EVENTSCODE_PasPar(SD_Pas_quartiled == 3)*1000,1,2)+ repmat([101 103],size(EVENTSCODE_PasPar(SD_Pas_quartiled == 3),1),1);
TABLE{33,2}   = repmat(EVENTSCODE_FutPar(SD_Fut_quartiled == 3)*1000,1,2)+ repmat([121 123],size(EVENTSCODE_FutPar(SD_Fut_quartiled == 3),1),1);
TABLE{34,2}   = repmat(EVENTSCODE_PreW(SD_W_quartiled == 3)*1000,1,2)+ repmat([141 143],size(EVENTSCODE_PreW(SD_W_quartiled == 3),1),1);
TABLE{35,2}   = repmat(EVENTSCODE_PreE(SD_E_quartiled == 3)*1000,1,2)+ repmat([161 163],size(EVENTSCODE_PreE(SD_E_quartiled == 3),1),1);

TABLE{36,2}   = repmat(EVENTSCODE_PrePar(SD_Par_quartiled == 4)*1000,1,2) + repmat([81 83],size(EVENTSCODE_PrePar(SD_Par_quartiled == 4),1),1);
TABLE{37,2}   = repmat(EVENTSCODE_PasPar(SD_Pas_quartiled == 4)*1000,1,2)+ repmat([101 103],size(EVENTSCODE_PasPar(SD_Pas_quartiled == 4),1),1);
TABLE{38,2}   = repmat(EVENTSCODE_FutPar(SD_Fut_quartiled == 4)*1000,1,2)+ repmat([121 123],size(EVENTSCODE_FutPar(SD_Fut_quartiled == 4),1),1);
TABLE{39,2}   = repmat(EVENTSCODE_PreW(SD_W_quartiled == 4)*1000,1,2)+ repmat([141 143],size(EVENTSCODE_PreW(SD_W_quartiled == 4),1),1);
TABLE{40,2}   = repmat(EVENTSCODE_PreE(SD_E_quartiled == 4)*1000,1,2)+ repmat([161 163],size(EVENTSCODE_PreE(SD_E_quartiled == 4),1),1);
