function [condnames,dataset] = make_AVG_EVpastvsprevsfutvswvse_true(datasource,rejectvisual)
...
select_event{2} = [TABLE{2,2}(:) ];
select_event{3} = [TABLE{3,2}(:) ];
select_event{4} = [TABLE{4,2}(:) ];
select_event{5} = [TABLE{5,2}(:) ];
