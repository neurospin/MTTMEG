function [condnames,dataset] = make_AVG_QTshifts_EVT(datasource,rejectvisual)
...
%% condames
condnames = {'QtSpaceShiftEVT';'QtNoShiftEVT';'QtTimeShiftEVT'};

%% trial selection
select_event{1} = [TABLE{4,2}(:) ; TABLE{5,2}(:) ];
select_event{2} = [TABLE{1,2}(:) ];
select_event{3} = [TABLE{2,2}(:) ; TABLE{3,2}(:) ];
