function [condnames,dataset,dist_val,tag] = make_AVG_signDIST36_EVT_Pre_True(datasource,rejectvisual)
...
for i = 1:length(select_event)
    condnames{i} = {['sDT_Pre' num2str(dist_val(i))]}
end
