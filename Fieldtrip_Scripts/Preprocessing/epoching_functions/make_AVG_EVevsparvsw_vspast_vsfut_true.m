function [condnames,dataset] = make_AVG_EVevsparvsw_vspast_vsfut_true(datasource,rejectvisual)
...
select_event{2} = [TABLE{7,2}(:) ];
select_event{3} = [TABLE{8,2}(:) ];
select_event{4} = [TABLE{9,2}(:) ];
select_event{5} = [TABLE{10,2}(:) ];
