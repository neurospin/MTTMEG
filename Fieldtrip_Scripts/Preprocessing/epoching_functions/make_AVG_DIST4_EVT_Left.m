function [condnames,dataset] = make_AVG_DIST4_EVT_True_Left(datasource,rejectvisual)
...
TABLE{1,2}     = repmat(EVENTSCODE_PrePar(TD_Pre_quartiled == 1)*1000,1,1) + repmat(61,size(EVENTSCODE_PrePar(TD_Pre_quartiled == 1),1),1);
TABLE{2,2}     = repmat(EVENTSCODE_PasPar(TD_Pas_quartiled == 1)*1000,1,1)+ repmat(81,size(EVENTSCODE_PasPar(TD_Pas_quartiled == 1),1),1);
TABLE{3,2}     = repmat(EVENTSCODE_FutPar(TD_Fut_quartiled == 1)*1000,1,1)+ repmat(101,size(EVENTSCODE_FutPar(TD_Fut_quartiled == 1),1),1);
TABLE{4,2}     = repmat(EVENTSCODE_PreW(TD_W_quartiled == 1)*1000,1,1)+ repmat(121,size(EVENTSCODE_PreW(TD_W_quartiled == 1),1),1);
TABLE{5,2}     = repmat(EVENTSCODE_PreE(TD_E_quartiled == 1)*1000,1,1)+ repmat(141,size(EVENTSCODE_PreE(TD_E_quartiled == 1),1),1);

TABLE{6,2}     = repmat(EVENTSCODE_PrePar(TD_Pre_quartiled == 2)*1000,1,1) + repmat(61,size(EVENTSCODE_PrePar(TD_Pre_quartiled == 2),1),1);
TABLE{7,2}     = repmat(EVENTSCODE_PasPar(TD_Pas_quartiled == 2)*1000,1,1)+ repmat(81,size(EVENTSCODE_PasPar(TD_Pas_quartiled == 2),1),1);
TABLE{8,2}     = repmat(EVENTSCODE_FutPar(TD_Fut_quartiled == 2)*1000,1,1)+ repmat(101,size(EVENTSCODE_FutPar(TD_Fut_quartiled == 2),1),1);
TABLE{9,2}     = repmat(EVENTSCODE_PreW(TD_W_quartiled == 2)*1000,1,1)+ repmat(121,size(EVENTSCODE_PreW(TD_W_quartiled == 2),1),1);
TABLE{10,2}   = repmat(EVENTSCODE_PreE(TD_E_quartiled == 2)*1000,1,1)+ repmat(141,size(EVENTSCODE_PreE(TD_E_quartiled == 2),1),1);

TABLE{11,2}   = repmat(EVENTSCODE_PrePar(TD_Pre_quartiled == 3)*1000,1,1) + repmat(61,size(EVENTSCODE_PrePar(TD_Pre_quartiled == 3),1),1);
TABLE{12,2}   = repmat(EVENTSCODE_PasPar(TD_Pas_quartiled == 3)*1000,1,1)+ repmat(81,size(EVENTSCODE_PasPar(TD_Pas_quartiled == 3),1),1);
TABLE{13,2}   = repmat(EVENTSCODE_FutPar(TD_Fut_quartiled == 3)*1000,1,1)+ repmat(101,size(EVENTSCODE_FutPar(TD_Fut_quartiled == 3),1),1);
TABLE{14,2}   = repmat(EVENTSCODE_PreW(TD_W_quartiled == 3)*1000,1,1)+ repmat(121,size(EVENTSCODE_PreW(TD_W_quartiled == 3),1),1);
TABLE{15,2}   = repmat(EVENTSCODE_PreE(TD_E_quartiled == 3)*1000,1,1)+ repmat(141,size(EVENTSCODE_PreE(TD_E_quartiled == 3),1),1);

TABLE{16,2}   = repmat(EVENTSCODE_PrePar(TD_Pre_quartiled == 4)*1000,1,2) + repmat(61:62,size(EVENTSCODE_PrePar(TD_Pre_quartiled == 4),1),1);
TABLE{17,2}   = repmat(EVENTSCODE_PasPar(TD_Pas_quartiled == 4)*1000,1,2)+ repmat(81:82,size(EVENTSCODE_PasPar(TD_Pas_quartiled == 4),1),1);
TABLE{18,2}   = repmat(EVENTSCODE_FutPar(TD_Fut_quartiled == 4)*1000,1,2)+ repmat(101:102,size(EVENTSCODE_FutPar(TD_Fut_quartiled == 4),1),1);
TABLE{19,2}   = repmat(EVENTSCODE_PreW(TD_W_quartiled == 4)*1000,1,2)+ repmat(121:122,size(EVENTSCODE_PreW(TD_W_quartiled == 4),1),1);
TABLE{20,2}   = repmat(EVENTSCODE_PreE(TD_E_quartiled == 4)*1000,1,2)+ repmat(141:142,size(EVENTSCODE_PreE(TD_E_quartiled == 4),1),1);
...
%% condames
condnames = {'EtDtq1G_L';'EtDtq2G_L';'EtDtq3G_L';'EtDtq4G_L'};
