function [condnames,dataset] = make_AVG_westeast_intcou(datasource,rejectvisual)
...
%% condames
condnames = {'rWest_int';'rEast_int';'rWest_cou';'rEast_cou'};
...
select_event{4} = [TABLE{36,2}(:); TABLE{37,2}(:); TABLE{38,2}(:); TABLE{39,2}(:); TABLE{30,2}(:)];
