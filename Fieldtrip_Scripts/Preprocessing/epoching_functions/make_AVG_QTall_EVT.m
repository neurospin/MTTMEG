function [condnames,dataset] = make_AVG_QTall_EVT(datasource,rejectvisual)
...
%% condames
condnames = {'QtWestEVT';'QtEastEVT';'QtParEVT';'QtPastEVT';'QtFutEVT'};

%% trial selection
select_event{1} = [TABLE{4,2}(:) ];
select_event{2} = [TABLE{5,2}(:) ];
select_event{3} = [TABLE{1,2}(:) ];
select_event{4} = [TABLE{2,2}(:) ];
select_event{5} = [TABLE{3,2}(:) ];
