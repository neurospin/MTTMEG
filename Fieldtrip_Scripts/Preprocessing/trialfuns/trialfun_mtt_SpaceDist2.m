...
x = []; y = [];
[x19,y19] = find(valuetrigcorr == 19);
[x23,y23] = find(valuetrigcorr == 23);
[x27,y27] = find(valuetrigcorr == 27);
[x31,y31] = find(valuetrigcorr == 31);
[x35,y35] = find(valuetrigcorr == 35);

x = [x19 x23 x27 x31 x35];
y = [y19 y23 y27 y31 y35];
