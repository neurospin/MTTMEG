...
%% test dataset
% cfg.dataset = 'C:\MTT_MEG\data\sd130343\run5_GD_trans_sss.fif';
...
[x6,y6]   = find(valuetrigcorr == 6);
[x8,y8]   = find(valuetrigcorr == 8);
[x10,y10] = find(valuetrigcorr == 10);
[x12,y12] = find(valuetrigcorr == 12);
[x14,y14] = find(valuetrigcorr == 14);
