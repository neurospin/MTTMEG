...
x = []; y = [];
[x18,y18] = find(valuetrigcorr == 18);
[x22,y22] = find(valuetrigcorr == 22);
[x26,y26] = find(valuetrigcorr == 26);
[x30,y30] = find(valuetrigcorr == 30);
[x34,y34] = find(valuetrigcorr == 34);

x = [x18 x22 x26 x30 x34];
y = [y18 y22 y26 y30 y34];
