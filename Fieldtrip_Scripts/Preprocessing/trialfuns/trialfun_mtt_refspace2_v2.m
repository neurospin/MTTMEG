function [trl] = trialfun_mtt_refspace2_v2(cfg)
...
x = []; y = [];
[x,y] = find(valuetrig == 7);

for i = 1:length(x)
    trl(i,1) = sample(y(i)) - cfg.trialdef.prestim*hdr.Fs + cfg.photodelay*hdr.Fs;
    trl(i,2) = sample(y(i)) + cfg.trialdef.poststim*hdr.Fs + cfg.photodelay*hdr.Fs;
    trl(i,3) = 0;
end
