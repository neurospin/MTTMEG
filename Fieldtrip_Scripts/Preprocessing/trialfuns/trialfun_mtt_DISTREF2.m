...
%% test dataset
% cfg.dataset = 'C:\MTT_MEG\MEG\data\sd130343\run3_DG_trans_sss.fif';
...
x = []; y = [];
[x20,y20] = find(valuetrig == 20);
[x21,y21] = find(valuetrig == 21);
[x22,y22] = find(valuetrig == 22);
[x23,y23] = find(valuetrig == 23);
