...
%% test dataset
% cfg.dataset = '/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/MEG/lm130479/raw_sss/run4_DG_trans_sss.fif';
...
x = []; y = [];
[x,y] = find(valuetrigcorr == 5);


% count = 1;
% for i = 1:length(x)
%     if samplecorr(x(i)) >= hdr.orig.raw.first_samp % check if by bad luck you forgot to quickly click on "record raw"...
