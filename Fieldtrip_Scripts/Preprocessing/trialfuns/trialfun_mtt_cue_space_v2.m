function [trl] = trialfun_mtt_cue_space_v2(cfg)

%% test dataset
% cfg.dataset = 'C:\MTT_MEG\data\subj1\run4_right_trans_sss.fif';
...
% a =  1;
% for i = 1:size(B3,1)
%     if B3(i,2) == 2 && (B3(i,3) == 1015 || B3(i,3) == 1014 || B3(i,3) == 1016)
