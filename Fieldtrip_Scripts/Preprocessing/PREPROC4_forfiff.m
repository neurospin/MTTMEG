function PREPROC4_forfiff(runlist,delays,windowsERF,windowsTF,trialfun,condtag,nip)
...
save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' nip '/MegData/Processed_new/' condtag 'forfiff_filt40.mat'],'datafilt40','trldef')
save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' nip '/MegData/Processed_new/' condtag 'forfiff.mat'],'data','trldef')
