function PREPROC3_EEG(runlist,delays,windows,trialfun,condname,nip,badEEG)
...
for i = 1:length(condtrigs)
    ...
    datafilt40 = ft_redefinetrial(cfg,datafilt40_);
    save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' nip '/MegData/Processed/' condname{i} 'EEG_filt40.mat'],'datafilt40')
    data = ft_redefinetrial(cfg,data_);
    save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' nip '/MegData/Processed/' condname{i} 'EEG.mat'],'data')
end
