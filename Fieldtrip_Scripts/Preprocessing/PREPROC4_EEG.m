function PREPROC4_EEG(runlist,delays,windowsERF,windowsTF,trialfun,condtag,nip,badEEG)
...
for i = 1:length(runlist)
    data{i}        = run_preproc(root,runlist{i},delays,windowsTF,trialfun);
    datafilt40{i} = run_preproc_filt40(root,runlist{i},delays,windowsERF,trialfun);
end
...
trldefsave = trldef;
trldef = trldef40;
save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' nip '/MegData/Processed_eegnew/' condtag '_dat_filt40.mat'],'datafilt40','trldef')
trldef = trldefsave;
save(['/neurospin/meg/meg_tmp/MTT_MEG_Baptiste/From_laptop/Subjects/' nip '/MegData/Processed_eegnew/' condtag '_dat_.mat'],'data','trldef')
